...
namespace Octgn.Networking
{
    public sealed class Handler
    {
        ...
        public void Start()
        {
            ...
            if (App.PlayWindow != null)
            {
                App.PlayWindow.PreGameLobby.Start(false);
            }
        ...
        public void StartLimited(Player player, Guid[] packs)
        {
            ...
            if (Player.LocalPlayer.Spectator == false)
            {
                ...
                App.PlayWindow.ShowBackstage(wnd);
                wnd.OpenPacks(packs);
            }
        }
        ...
        {
            WriteReplayAction(player.Id);
            var wnd = (Play.Dialogs.PickCardsDialog)App.PlayWindow.backstage.Child;
