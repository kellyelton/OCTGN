...
namespace Octgn.Scripting.Controls
{
    public static class Dialog
    {
        ...
        public static bool Confirm(string prompt)
        {
            //fix MAINWINDOW bug
            return
                MessageBox.Show(App.PlayWindow, prompt, "Confirmation", MessageBoxButton.YesNo,
        ...
        {
            //fix MAINWINDOW bug
            MessageBox.Show(App.PlayWindow, msg, "Message", MessageBoxButton.OK, MessageBoxImage.Information);
        }
    }
}